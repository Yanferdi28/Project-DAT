            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                    ...
                    <select
                        ...
                        className="flex-1 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                    >
                    ...
                    <div className="px-6 py-3 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                        <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">
                                {t('users.page')} {subKategoris.current_page} {t('users.of')} {subKategoris.last_page}
                            </span>
                            ...
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    size="sm"
                                    onClick={() => {
                                        const prevLink = subKategoris.links.find(link => link.label.includes('Previous') || link.label.includes('&laquo;'));
                                        if (prevLink?.url) router.get(prevLink.url);
                                    }}
                                    disabled={subKategoris.current_page === 1}
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    onClick={() => {
                                        const nextLink = subKategoris.links.find(link => link.label.includes('Next') || link.label.includes('&raquo;'));
                                        if (nextLink?.url) router.get(nextLink.url);
                                    }}
                                    disabled={subKategoris.current_page === subKategoris.last_page}
                                    className="flex items-center gap-2"
                                >
                                    {t('users.next')}
