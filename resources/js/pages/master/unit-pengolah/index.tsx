                    ...
                    <div className="px-6 py-3 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                        <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-600 dark:text-gray-400">
                                {t('users.page')} {unitPengolahs.current_page} {t('users.of')} {unitPengolahs.last_page}
                            </span>
                            ...
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    size="sm"
                                    onClick={() => {
                                        const prevLink = unitPengolahs.links.find(link => link.label.includes('Previous') || link.label.includes('&laquo;'));
                                        if (prevLink?.url) router.get(prevLink.url);
                                    }}
                                    disabled={unitPengolahs.current_page === 1}
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    onClick={() => {
                                        const nextLink = unitPengolahs.links.find(link => link.label.includes('Next') || link.label.includes('&raquo;'));
                                        if (nextLink?.url) router.get(nextLink.url);
                                    }}
                                    disabled={unitPengolahs.current_page === unitPengolahs.last_page}
                                    className="flex items-center gap-2"
                                >
                                    {t('users.next')}
