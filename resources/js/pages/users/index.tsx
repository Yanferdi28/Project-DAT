                        ...
                        <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
                            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    ...
                                    {'dari'} <span className="font-medium">{users.total}</span> {'pengguna terdaftar'}
                                </p>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            <span className="font-semibold">{deleteDialog.user?.name}</span>? {'Tindakan ini tidak dapat dibatalkan.'}
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
                        ...
                        <DialogDescription>
                            {verifyDialog.action === 'verify' ? (
                                <>
                                    ...
                                    <span className="font-semibold">{verifyDialog.user?.name}</span>? {'Pengguna akan ditandai sebagai terverifikasi.'}
                                </>
                            ) : (
                                <>
                                    {'Apakah Anda yakin ingin membatalkan verifikasi email pengguna'}{' '}
                                    <span className="font-semibold">{verifyDialog.user?.name}</span>? {'Pengguna akan ditandai sebagai belum terverifikasi.'}
                                </>
                            )}
                        </DialogDescription>
                    </DialogHeader>
